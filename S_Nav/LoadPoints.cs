...
namespace S_Nav
{
    ...
    class LoadPoints
    {
        ...
        public List<MapPoint> loadE2Points(int width, int height)
        {
            List<MapPoint> points = new List<MapPoint>();
            ...
            // non-room points
            // floor traversal
            points.Add(new MapPoint("stairsTopLeft", new SKPoint(width * .23f, height * .26f)));//topleft stairs 
            points.Add(new MapPoint("stairsTopRight", new SKPoint(width * .885f, height * .30f))); //topRight stairs
            points.Add(new MapPoint("stairsBottomLeft", new SKPoint(width * .36f, height * .96f))); //bottom left stairs
            points.Add(new MapPoint("stairsMiddle", new SKPoint(width * .525f, height * .54f))); //bottom left stairs
            ...
            points.Add(new MapPoint("hallLowereft", new SKPoint(width * .37f, height * .73f)));
            points.Add(new MapPoint("hallBottomLeft", new SKPoint(width * .37f, height * .90f)));
        ...
        public List<MapPoint> loadE1Points(int width, int height)
        {
            List<MapPoint> points = new List<MapPoint>();
            ...
            //hallway points
            points.Add(new MapPoint("hallFarLeft", new SKPoint(width * .18f, height * .24f))); //adjust
