...
namespace S_Nav
{
    ...
    class LoadPoints
    {
        ...
        public List<MapPoint> loadPoints(int width, int height)
        {
            ...
            /*
            //hallway points for first floor
            ...
            */
            ...
            /*
            // floor traversal points for E wing
            ...
            */
            ...
            //points.Add(new MapPoint("G201", new SKPoint(width * .46f, height * .73f))); 
            points.Add(new MapPoint("G202", new SKPoint(width * .5f, height * .53f))); 
            //points.Add(new MapPoint("G203", new SKPoint(width * .79f, height * .24f))); 
            //points.Add(new MapPoint("G204", new SKPoint(width * .79f, height * .24f))); 
            //points.Add(new MapPoint("G205", new SKPoint(width * .79f, height * .24f))); 
            points.Add(new MapPoint("G206", new SKPoint(width * .55f, height * .82f))); 
            //points.Add(new MapPoint("G207", new SKPoint(width * .79f, height * .24f))); 
